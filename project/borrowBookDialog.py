...
class borrowBookDialog(QDialog):
    ...
    def setUpUI(self):
        ...
        # Label控件
        self.borrowStudentLabel = QLabel("Borrower's ID:")
        # self.borrowStudentIdLabel = QLabel(self.studentId)
        self.borrowStudentNameLabel = QLabel("Borrower's Name:")
        self.borrowStudentKeshiLabel=QLabel("Devision:")
        self.titlelabel = QLabel("Book")
        self.bookNameLabel = QLabel("Book Name:")
        self.bookIdLabel = QLabel("Book ID:")
        self.authNameLabel = QLabel("Authoer:")
